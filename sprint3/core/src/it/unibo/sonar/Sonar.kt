		...
		return { //this:ActionBasciFsm
				...
				state("idle") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t053",targetState="handleRequest",cond=whenRequest("getValue"))
					transition(edgeName="t054",targetState="handleSetValue",cond=whenDispatch("setValue"))
				}
