		...
		return { //this:ActionBasciFsm
				...
				state("idle") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t057",targetState="check",cond=whenTimeout("local_tout_weight_idle"))   
					transition(edgeName="t058",targetState="handleRequest",cond=whenRequest("getValue"))
					transition(edgeName="t059",targetState="handleSetWeight",cond=whenDispatch("setValue"))
				}	 
