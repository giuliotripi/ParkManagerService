	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("handleCarEnter3") { //this:State
					...
					transition(edgeName="t2b6",targetState="handleCarEnterMoveError",cond=whenReply("moveError"))
				}	 
				state("handleCarEnterMoveError") { //this:State
					action { //it:State
						answer("carEnter", "error", "error(trolleyerror)"   )  
					}
					 transition( edgeName="goto",targetState="idle", cond=doswitch() )
				}	 
				state("handleCarEnter4") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t2c7",targetState="handleCarEnter5",cond=whenReply("moveDone"))
					transition(edgeName="t2c8",targetState="idle",cond=whenReply("moveError"))
				}	 
				state("handleCarEnter5") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t2d9",targetState="handleCarEnter6",cond=whenTimeout("local_tout_parkingservice_handleCarEnter5"))   
					transition(edgeName="t2d10",targetState="handleCarEnter1",cond=whenRequest("carEnter"))
					transition(edgeName="t2d11",targetState="handlePickUp1",cond=whenRequest("pickUpRequest"))
				}	 
				state("handleCarEnter6") { //this:State
					action { //it:State
						request("moveToHome", "moveToHome(X)" ,"trolley" )  
					}
					 transition(edgeName="t2e12",targetState="handleCarEnter7",cond=whenReply("moveDone"))
					transition(edgeName="t2e13",targetState="idle",cond=whenReply("moveError"))
				}	 
				...
				state("handlePickUp1") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t3a14",targetState="handlePickUp2",cond=whenReply("sensorValue"))
				}	 
				state("handlePickUp2") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("sensorValue(VALUE,SENSORNAME)"), Term.createTerm("sensorValue(DISTANCE,distance)"), 
												...
												val sonarState = payloadArg(0).toDouble()
				...
				state("handlePickUp3") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t3b15",targetState="handlePickUp4",cond=whenReply("moveDone"))
					transition(edgeName="t3b16",targetState="idle",cond=whenReply("moveError"))
				}	 
				state("handlePickUp4") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t3c17",targetState="handlePickUp5",cond=whenReply("moveDone"))
					transition(edgeName="t3c18",targetState="handlePickUpMoveError",cond=whenReply("moveError"))
				}	 
				state("handlePickUpMoveError") { //this:State
					action { //it:State
						answer("pickUpRequest", "error", "error(trolleyerror)"   )  
					}
					 transition( edgeName="goto",targetState="idle", cond=doswitch() )
				}	 
				state("handlePickUp5") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t3d19",targetState="handlePickUp6",cond=whenTimeout("local_tout_parkingservice_handlePickUp5"))   
					transition(edgeName="t3d20",targetState="handleCarEnter1",cond=whenRequest("carEnter"))
					transition(edgeName="t3d21",targetState="handlePickUp1",cond=whenRequest("pickUpRequest"))
				}	 
				state("handlePickUp6") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t3e22",targetState="handlePickUp7",cond=whenReply("moveDone"))
					transition(edgeName="t3e23",targetState="idle",cond=whenReply("moveError"))
				}	 
