		...
		return { //this:ActionBasciFsm
				...
				state("idle") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t067",targetState="handleRequest",cond=whenRequest("getValue"))
					transition(edgeName="t068",targetState="handleSetValue",cond=whenDispatch("setValue"))
				}	 
